...
#I was too lazy to create a simple user interface, so just change the two
#variables below to navigate through the word levels.
selectedIndex = 0
selectedLevel = level_9
#########################################################################
#You are of course allowed to modify the code however you want, and you may
#even want to do that since I did not include any "randomise" modes and such

#It's pretty simple code but if you DM me on discord I can comment on each
#line of code in case you don't understand.
